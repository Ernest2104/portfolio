...
function espIng() {
  ...
  document.getElementById("curriculum").innerHTML = "Download my resume"
...
function ingEsp() {
  ...
  if (buttonDark.innerText === "Dark Mode") {
    ...
    document.getElementById("contactar").innerHTML = "Contacto";
    ...
    document.getElementById("curriculum").innerHTML = "Descarga mi curriculum"
